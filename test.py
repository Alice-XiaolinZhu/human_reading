...
import os
import numpy as np
embedding_useds = ["None", "JWE", "CW2VEC", "GWE"]
gaussian_var1 = 0.0
gaussian_var2 = 0.1
gaussian_var3 = 0.5
...
params = [[True, False, 1, False], [False, True, 1, False], [True, True, 1, False], [False, False, 3, False], [False, False, 2, False], [False, False, 3, True]] 
