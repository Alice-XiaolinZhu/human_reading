...
import os
import numpy as np
embedding_useds = ["None"] #["CWE", "JWE", "CW2VEC", "GWE"]
gaussian_var1 = 0.02
gaussian_var2 = 0.1
gaussian_var3 = 0.5

lambdas = [4.5] #list(np.array([*range(3000, 6250, 250)])/1000)
...
params = [[False, False, 3, False]] #[[True, False, 0, False], [False, True, 0, False], [True, True, 0, False], [False, False, 3, False], [False, False, 3, True]] 
